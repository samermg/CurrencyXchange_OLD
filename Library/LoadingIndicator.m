...
//  LoadingIndicator
//
//  Created by Samer Ghanim on 2021/8/11.
//  Copyright © 2021 Samer Ghanim. All rights reserved.
//
...
typedef void (^DisableImplictBlock) (void) ;

@interface LoadingIndicator () <CAAnimationDelegate>
...
- (void)setLineWidth:(CGFloat)lineWidth {
    ...
    [self stopImplictAnimation:^() {
        self.circleLayer.lineWidth = self->_lineWidth;
    }];
}
